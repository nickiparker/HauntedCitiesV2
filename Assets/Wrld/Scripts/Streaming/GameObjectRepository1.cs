...
{
    public class GameObjectRecord1
    {
    ...
    public class GameObjectRepository1
    {
        ...
        public GameObjectRepository1(string rootName, Transform parentForStreamedObjects, MaterialRepository materialRepository, bool applyFlattening)
        {
