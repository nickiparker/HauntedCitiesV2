...
namespace AiGame
{
    public class NavmeshbuildingExample : MonoBehaviour
    {
        public static NavmeshbuildingExample Instance;
        ...
        IEnumerator setup()
        {
            ...
            /**
            roadsObj = GameObject.Find("Roads");
            roadsMesh = roadsObj.GetComponentsInChildren<MeshRenderer>();
            roads = new GameObject[roadsMesh.Length];
            int i = 0;
            foreach (MeshRenderer child in roadsMesh)
            {
                roads[i] = child.gameObject;
                roads[i].layer = LayerMask.NameToLayer("NavMeshBuild"); 
                i++;
            }
            ...
            k = 0;
            groundObj = GameObject.Find("Terrain");
            groundMesh = groundObj.GetComponentsInChildren<MeshRenderer>();
            ground = new GameObject[groundMesh.Length];
         
            foreach (MeshRenderer child in groundMesh)
            {
                ground[k] = child.gameObject;
                ground[k].layer = LayerMask.NameToLayer("NavMeshBuild");
                k++;
            }
            /**
            GameObject newRoad = Instantiate(roadSpawn, roadsObj.transform.position, Quaternion.identity);
            newRoad.transform.localRotation = Quaternion.Euler(new Vector3(0, 32, 0));
            newRoad.transform.localPosition = new Vector3(-4.388f, 0.05f, -2.753f);
            newRoad.layer = LayerMask.NameToLayer("NavMeshBuild");
            * /
            Build();
            ...
            */
            ...
            waypoints[0].transform.localPosition = new Vector3(-1.519f, 0.2797f, 6.761f);
            waypoints[1].transform.localPosition = new Vector3(0.1f, 0.2808849f, -0.302f);
            waypoints[2].transform.localPosition = new Vector3(7.344f, 0.1833339f, -0.576f);
            waypoints[3].transform.localPosition = new Vector3(0.01257612f, 0.3000002f, -2.909342f);
            waypoints[4].transform.localPosition = new Vector3(-2.387f, 0.2666669f, -6.953f);
            waypoints[5].transform.localPosition = new Vector3(-4.44f, 0.2750003f, 2.22f);
            waypoints[6].transform.localPosition = new Vector3(3.837f, 0.2750006f, -5.872f);
            waypoints[7].transform.localPosition = new Vector3(-7.32f, 0.341f, 4.324f);
            waypoints[8].transform.localPosition = new Vector3(-7.126f, 0.22199998f, -2.74f);
            waypoints[9].transform.localPosition = new Vector3(3.35f, 0.22199998f, 5.01f);
            ...
            waypoints[8].GetComponent<Waypoint>().neighbors.Add(waypoints[4].GetComponent<Waypoint>());
            waypoints[8].GetComponent<Waypoint>().neighbors.Add(waypoints[3].GetComponent<Waypoint>());
            waypoints[9].GetComponent<Waypoint>().neighbors.Add(waypoints[2].GetComponent<Waypoint>());
            waypoints[9].GetComponent<Waypoint>().neighbors.Add(waypoints[1].GetComponent<Waypoint>());
